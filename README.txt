...
- Informative error handling, no dedicated error screens/handling implemented so far 
- Confirmation when deleting

*** Other bugs, things in need of fixes *** 

- prevent resubmission upon refresh (though entries are easily deleted)
...
- perhaps add a way to reset auto increment through GUI (currently must be done via database)