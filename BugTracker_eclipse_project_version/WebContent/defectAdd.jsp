...
<title> Submit a Bug Ticket </title>
</head>
...
<%-- not needed
            ...
            <br />
            <div>
                <label for="appID"> Application ID: </label> <input type="number"
            ...
            <p> (An application must be added before a bug report can be submitted.) </p>
            <div>
...
<%--             
            ...
            <div>
                <label for="summary"> Summary: </label> <input type="text"
                    ...
                    placeholder="Brief summary of bug (100 characters)" size="50" 
                    maxlength="100"/>
            </div>
            <br />
            <div>
                <label for="dDescript"> Detailed Description: <br /><br /></label>
                <textarea class="text" cols="70" rows="6" name="dDescript" 
                placeholder="Describe in detail (300 characters)" maxlength="300" ></textarea>                                                         
            </div> 
            <br />                        
            <div>
    ...
    <a href = DefectControllerServlet?action=list> List of bug reports </a></p>
    
	<p>
<%--         Debug: <c:out value="${openAppList}" /></td> --%>
    </p>
